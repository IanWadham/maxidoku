...
class CellView extends StatelessWidget
{
  ...
  final int cellBg;		// Cell's colour - emptyCellColor or specialCellColor.
  final double f;		// Font height.

  CellView(this.x, this.y, this.index, this.cellBg, this.f, {Key? key})
      : super(key: key);
  ...
  {
    debugPrint('Building CELL $x,$y: index $index');
    ...
    // Get Provider to check if cell value or status have changed. If so, repaint cell.
...
//        have NULL Gradients. Control-cell zero could be passes Notes 1 2 3...
    ...
    if (cellBg == UNUSABLE) {
      ...
      // Add a live, tappable spot to the 2D Sudoku grid. First set colours and font-size.
      Color  cellBackground = cellBg == SPECIAL ?
      ...
      // Return the required variety of cell-widget.
      return AspectRatio(
        aspectRatio: 1.0,		// Cell is a square.
        child: GestureDetector(
          onTap: () {
            debugPrint('Tapped cell ${x}, ${y}');
          ...
          child: DecoratedBox(
            ...
            child: Align (alignment: Alignment.center,	// Vertical and horiz. centering.
              child: Text(
