 ...
 * the Load action.
 *
 * The data structures in PuzzleMap can be generated by program, as in Roxdoku
 * and Classic Sudoku, or loaded from XML files in the src/shapes sub-directory.
 * See the methods initSudoku(), initRoxdoku() and initCustom() in PuzzleMap.
 *
...
class PuzzleMap
{
  ...
  void addCage(/* const */ List<int> cage, CageOperator cageOperator,
                      int cageValue)
  {
        ...
        // TODO - Check that the logic of this loop has been inverted correctly.
  ...
  void dropCage(int cageNum)
  {
        ...
        /* TODO - Garbage-collect should take care of this?
        delete _cages.elementAt (cageNum);
        */
  ...
  void clearCages() {
        ...
        if (! _cages.isEmpty) {
            // TODO - Need something like this? --- qDeleteAll (_cages);
            _cages.clear();
        }
  }
  ...
  {
    // TODO - Check for second occurrence of this spec line.
    if (nFields < 2) {
  ...
  void printBoard(BoardContents board)
  {
    ...
    for (int y=0; y < _sizeY; y++) {
      ...
      for (int x=0; x < _sizeX; x++) {
        value = board[x * _sizeY + y]; // TODO - ?? UNUSABLE - 1;
        if (value == UNUSABLE) {
